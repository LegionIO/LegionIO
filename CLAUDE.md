...
└── CLI (Thor)         # Unified CLI: exe/legion -> Legion::CLI::Main
    ...
    │   ├── ToolRegistry   # Chat tool discovery and registration (20 built-in + extension tools)
...
| `lib/legion/cli/chat/tool_registry.rb` | Chat tool discovery and registration (20 tools) |
